...
header.write( """#ifndef __%s_H
#define __%s_H
/* Autogenerated by ihex2carr.py */
#include <stdint.h>

extern const uint16_t %s_config;
extern const uint16_t %s_hex;

#endif /* __%s_H */
""" % (fprefix.upper(),fprefix.upper(),arrayname,arrayname,fprefix.upper()) )
header.close()

of = open( fprefix + ".c", "w" )

of.write("/* Autogenerated by ihex2carr.py */\n");
of.write("""#include "%s.h"\n\n""" % fprefix )
